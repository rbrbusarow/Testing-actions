...
/**
 * Looks for all references to project artifacts in the md/mdx files
...
val updateWebsiteNextDocsVersionRefs by tasks.registering {
  ...
  doLast {
    ...
    fileTree("$rootDir/website/docs") {
      ...
      .forEach { file ->
        file.updateProjectVersionRef(version)
      }
  }
}
...
val updateWebsitePackageJsonVersion by tasks.registering {
  ...
  description = "Updates the project version in package.json"
  group = "website"
...
/**
 * Looks for all references to project artifacts in the project README.md
...
val updateProjectReadmeVersionRefs by tasks.registering {
  ...
  doLast {
    ...
    File("$rootDir/README.md")
      .updateProjectVersionRef(version)
  }
}

fun File.updateProjectVersionRef(version: String) {
